...
public class CcsClient {
    ...
    private CcsClient(String projectId, String apiKey, boolean debuggable) {
        this();
        mApiKey = "AIzaSyANEMs0Q9f7V6hrKocgR7S5XYhiBFtrFvg";
    ...
    private void handleMessage(Map<String, Object> jsonMap) {
        ...
        if (messageType == null) {
            ...
            try {
                ...
                // Send ACK to CCS
                String apiKey = "AIzaSyANEMs0Q9f7V6hrKocgR7S5XYhiBFtrFvg";
    ...
    public static void main(String[] args) {
        final String projectId = "290538927222";
        ...
        final String toRegId ="APA91bGF0WV3igZ3EapEH2DEocYchyAR-sgAosJ6Vrj55-joC1HyUgKPIbo4rEGfjLX6x6Uo-K9vOT58d3CNLvSQ54JbC4dDioTT7Db5ZLgNhDDI15twvfR_O_l7Hm-xWbBQTJ-fXyOYojaP9E3XYxVL3EpWQDX0Jw";
